...
#
get_filename_component(filename "D:/360Downloads/SZ3/build/_deps/zstdfetched-subbuild/zstdfetched-populate-prefix/src/zstd-1.4.5.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/360Downloads/SZ3/build/_deps/zstdfetched-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-zstdfetched-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-zstdfetched-populate${i}")
